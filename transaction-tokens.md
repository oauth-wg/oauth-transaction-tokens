...
### Nesting
Alternatively, a Tx-Token MAY be a JWT Embedded Token {{JWTEmbeddedTokens}}, which embeds a Tx-Token by value. This nesting enables workloads in a call chain to assert their invocation during the call chain to downstream workloads.
