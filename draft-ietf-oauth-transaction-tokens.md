...
The Txn-Token SHOULD contain an `azd` claim. The value of this claim is a JSON object that contains key-value pairs, which together assert the details that remain immutable through the call-chain where this Txn-Token is used.
