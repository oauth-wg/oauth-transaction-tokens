...
* `req_ip` The IP address of the external requester. This MAY be the end-user or a robotic process that requested the Transaction. In the case of an internal request it may contain the IP address of the requesting workload.
