...
* By restricting workloads that can request Txn-Tokens, it ensures that Software Bill-Of-Materials (SBOM) attacks are prevented from all services that cannot request Txn-Tokens.
